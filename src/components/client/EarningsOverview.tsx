...
// client dashboard. KPIs on the left, a 12-month trend chart on the
// right (bars + cumulative line). Replaces the older
// "Net by month" section so the client gets the answer to
