...
export function EarningsTrendChart({ series, currency, height = 180 }: Props) {
  ...
  // down), but the cumulative line sits above zero for any client with
