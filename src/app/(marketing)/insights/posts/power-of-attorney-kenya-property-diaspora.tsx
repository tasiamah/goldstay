...
export const meta: PostMeta = {
  ...
  metaTitle: "Power of attorney for Kenyan property: diaspora",
  description:
  ...
  metaDescription:
    "A power of attorney is the cleanest way for a diaspora Kenyan to handle a property purchase, sale or other transaction without flying back.",
