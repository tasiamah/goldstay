...
export const meta: PostMeta = {
  ...
  metaTitle: "Send money to Kenya cheaply in 2026: Wise vs banks",
  description:
  ...
  metaDescription:
    "Diaspora Kenyans send over USD 5 billion home every year. Most of it pays more in fees than it should.",
