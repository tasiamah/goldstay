...
} from "./muthaiga-old-money-quietest-address";
import KileleshwaComplete, {
  meta as kileleshwaCompleteMeta,
} from "./kileleshwa-complete-guide-2026";
import HurlinghamComplete, {
  meta as hurlinghamCompleteMeta,
} from "./hurlingham-complete-guide-2026";
import LangataComplete, {
  meta as langataCompleteMeta,
} from "./langata-complete-guide-2026";
import SouthBVsSouthC, {
  meta as southBVsSouthCMeta,
} from "./south-b-vs-south-c-honest-comparison";
import EmbakasiExplained, {
  meta as embakasiExplainedMeta,
} from "./embakasi-massive-market-explained";
import BuruburuLegacy, {
  meta as buruburuLegacyMeta,
} from "./buruburu-legacy-estates-2026";
import RidgewaysGardenEstate, {
  meta as ridgewaysGardenEstateMeta,
} from "./ridgeways-garden-estate-underrated-north";
import SyokimauMlolongo, {
  meta as syokimauMlolongoMeta,
} from "./syokimau-mlolongo-mass-market-corridor";
import RuiruTatuCity, {
  meta as ruiruTatuCityMeta,
} from "./ruiru-tatu-city-and-beyond";
import AthiRiverComplete, {
  meta as athiRiverCompleteMeta,
} from "./athi-river-complete-guide-2026";

import KcbMortgage, {
  meta as kcbMortgageMeta,
} from "./kcb-mortgage-2026-complete-review";
import NcbaMortgage, {
  meta as ncbaMortgageMeta,
} from "./ncba-mortgage-2026-complete-review";
import StanbicMortgage, {
  meta as stanbicMortgageMeta,
} from "./stanbic-mortgage-2026-complete-review";
import KcbVsNcba, {
  meta as kcbVsNcbaMeta,
} from "./kcb-vs-ncba-mortgage-comparison-2026";
import HfcMortgage, {
  meta as hfcMortgageMeta,
} from "./hfc-mortgage-2026-review";

import SalaryNairobiApt, {
  meta as salaryNairobiAptMeta,
} from "./salary-needed-buy-nairobi-apartment-2026";
import SalaryKarenHome, {
  meta as salaryKarenHomeMeta,
} from "./salary-needed-buy-karen-home-2026";
import TotalCostOwnership, {
  meta as totalCostOwnershipMeta,
} from "./total-cost-ownership-nairobi-apartment-2026";

import SingleMumBuying, {
  meta as singleMumBuyingMeta,
} from "./buying-property-single-mum-kenya";
import RetirementProperty, {
  meta as retirementPropertyMeta,
} from "./property-for-retirement-kenya-full-plan";
import FreshGraduateBuying, {
  meta as freshGraduateBuyingMeta,
} from "./buying-property-fresh-graduate-nairobi";
import DoctorsBuying, {
...
import WhereToFindAirbnbCoHostNairobi, {
  meta as whereToFindAirbnbCoHostNairobiMeta,
} from "./where-to-find-airbnb-co-host-nairobi";
import HowToFindAPropertyManagerNairobi, {
  meta as howToFindAPropertyManagerNairobiMeta,
} from "./how-to-find-a-property-manager-nairobi";
...
import EighteenSeventyWestWestlandsHandoverGuide, {
  meta as eighteenSeventyWestWestlandsHandoverGuideMeta,
} from "./1870-west-westlands-handover-guide";
import RiversideOneResidencyNairobiOwnersGuide, {
  meta as riversideOneResidencyNairobiOwnersGuideMeta,
} from "./riverside-one-residency-nairobi-owners-guide";
...
import AirbnbNairobiCompleteHostGuide2026, {
  meta as airbnbNairobiCompleteHostGuide2026Meta,
} from "./airbnb-nairobi-complete-host-guide-2026";
import PropertyManagementNairobiWhatYouActuallyGet2026, {
  meta as propertyManagementNairobiWhatYouActuallyGet2026Meta,
} from "./property-management-nairobi-what-you-actually-get-2026";
import AirbnbHostKenyaFirst90Days, {
  meta as airbnbHostKenyaFirst90DaysMeta,
} from "./airbnb-host-kenya-first-90-days";
import HowMuchCanYouEarnAirbnbNairobi2026, {
  meta as howMuchCanYouEarnAirbnbNairobi2026Meta,
} from "./how-much-can-you-earn-airbnb-nairobi-2026";
...
import AirbnbPhotographyNairobiWhatGoodLooksLike, {
  meta as airbnbPhotographyNairobiWhatGoodLooksLikeMeta,
} from "./airbnb-photography-nairobi-what-good-looks-like";
import AirbnbGuestVettingNairobiHouseRules, {
  meta as airbnbGuestVettingNairobiHouseRulesMeta,
} from "./airbnb-guest-vetting-nairobi-house-rules";
import AirbnbReviewsNairobiGettingTo49, {
  meta as airbnbReviewsNairobiGettingTo49Meta,
} from "./airbnb-reviews-nairobi-getting-to-4-9";
import AirbnbVsServicedApartmentNairobi2026, {
  meta as airbnbVsServicedApartmentNairobi2026Meta,
} from "./airbnb-vs-serviced-apartment-nairobi-2026";
...
import WifiSpeedAirbnbNairobiWhatGuestsExpect, {
  meta as wifiSpeedAirbnbNairobiWhatGuestsExpectMeta,
} from "./wifi-speed-airbnb-nairobi-what-guests-expect";
import BackupPowerAirbnbNairobiInverterGuide, {
  meta as backupPowerAirbnbNairobiInverterGuideMeta,
} from "./backup-power-airbnb-nairobi-inverter-guide";
import WaterStorageAirbnbNairobiTanks, {
  meta as waterStorageAirbnbNairobiTanksMeta,
} from "./water-storage-airbnb-nairobi-tanks";
import LinenAndTowelsAirbnbNairobi, {
  meta as linenAndTowelsAirbnbNairobiMeta,
} from "./linen-and-towels-airbnb-nairobi";
import MattressAndSleepQualityAirbnbNairobi, {
  meta as mattressAndSleepQualityAirbnbNairobiMeta,
} from "./mattress-and-sleep-quality-airbnb-nairobi";
import SelfCheckInSmartLocksAirbnbNairobi, {
  meta as selfCheckInSmartLocksAirbnbNairobiMeta,
} from "./self-check-in-smart-locks-airbnb-nairobi";
import WelcomeBasketAirbnbNairobiWhatWorks, {
  meta as welcomeBasketAirbnbNairobiWhatWorksMeta,
} from "./welcome-basket-airbnb-nairobi-what-works";
import ParkingAndArrivalAirbnbNairobi, {
  meta as parkingAndArrivalAirbnbNairobiMeta,
} from "./parking-and-arrival-airbnb-nairobi";
import NoiseAndBlackoutCurtainsAirbnbNairobi, {
  meta as noiseAndBlackoutCurtainsAirbnbNairobiMeta,
} from "./noise-and-blackout-curtains-airbnb-nairobi";
...
export const posts: readonly Post[] = [
  ...
  { meta: hurlinghamCompleteMeta, Component: HurlinghamComplete },
  { meta: langataCompleteMeta, Component: LangataComplete },
  { meta: southBVsSouthCMeta, Component: SouthBVsSouthC },
  { meta: embakasiExplainedMeta, Component: EmbakasiExplained },
  { meta: buruburuLegacyMeta, Component: BuruburuLegacy },
  {
    meta: ridgewaysGardenEstateMeta,
    Component: RidgewaysGardenEstate,
  },
  { meta: syokimauMlolongoMeta, Component: SyokimauMlolongo },
  { meta: ruiruTatuCityMeta, Component: RuiruTatuCity },
  { meta: athiRiverCompleteMeta, Component: AthiRiverComplete },

  { meta: kcbMortgageMeta, Component: KcbMortgage },
  { meta: ncbaMortgageMeta, Component: NcbaMortgage },
  { meta: stanbicMortgageMeta, Component: StanbicMortgage },
  { meta: kcbVsNcbaMeta, Component: KcbVsNcba },
  { meta: hfcMortgageMeta, Component: HfcMortgage },

  { meta: salaryNairobiAptMeta, Component: SalaryNairobiApt },
  { meta: salaryKarenHomeMeta, Component: SalaryKarenHome },
  { meta: totalCostOwnershipMeta, Component: TotalCostOwnership },

  { meta: singleMumBuyingMeta, Component: SingleMumBuying },
  ...
  {
    meta: whereToFindAirbnbCoHostNairobiMeta,
    Component: WhereToFindAirbnbCoHostNairobi,
  },
  {
    meta: howToFindAPropertyManagerNairobiMeta,
    Component: HowToFindAPropertyManagerNairobi,
  },
  {
  ...
  {
    meta: eighteenSeventyWestWestlandsHandoverGuideMeta,
    Component: EighteenSeventyWestWestlandsHandoverGuide,
  },
  {
    meta: riversideOneResidencyNairobiOwnersGuideMeta,
    Component: RiversideOneResidencyNairobiOwnersGuide,
  },
  ...
  {
    meta: airbnbNairobiCompleteHostGuide2026Meta,
    Component: AirbnbNairobiCompleteHostGuide2026,
  },
  {
    meta: propertyManagementNairobiWhatYouActuallyGet2026Meta,
    Component: PropertyManagementNairobiWhatYouActuallyGet2026,
  },
  {
    meta: airbnbHostKenyaFirst90DaysMeta,
    Component: AirbnbHostKenyaFirst90Days,
  },
  {
    meta: howMuchCanYouEarnAirbnbNairobi2026Meta,
    Component: HowMuchCanYouEarnAirbnbNairobi2026,
  },
  {
  ...
  {
    meta: airbnbPhotographyNairobiWhatGoodLooksLikeMeta,
    Component: AirbnbPhotographyNairobiWhatGoodLooksLike,
  },
  {
    meta: airbnbGuestVettingNairobiHouseRulesMeta,
    Component: AirbnbGuestVettingNairobiHouseRules,
  },
  {
    meta: airbnbReviewsNairobiGettingTo49Meta,
    Component: AirbnbReviewsNairobiGettingTo49,
  },
  {
    meta: airbnbVsServicedApartmentNairobi2026Meta,
    Component: AirbnbVsServicedApartmentNairobi2026,
  },
  {
  ...
  {
    meta: wifiSpeedAirbnbNairobiWhatGuestsExpectMeta,
    Component: WifiSpeedAirbnbNairobiWhatGuestsExpect,
  },
  {
    meta: backupPowerAirbnbNairobiInverterGuideMeta,
    Component: BackupPowerAirbnbNairobiInverterGuide,
  },
  {
    meta: waterStorageAirbnbNairobiTanksMeta,
    Component: WaterStorageAirbnbNairobiTanks,
  },
  {
    meta: linenAndTowelsAirbnbNairobiMeta,
    Component: LinenAndTowelsAirbnbNairobi,
  },
  {
    meta: mattressAndSleepQualityAirbnbNairobiMeta,
    Component: MattressAndSleepQualityAirbnbNairobi,
  },
  {
    meta: selfCheckInSmartLocksAirbnbNairobiMeta,
    Component: SelfCheckInSmartLocksAirbnbNairobi,
  },
  {
    meta: welcomeBasketAirbnbNairobiWhatWorksMeta,
    Component: WelcomeBasketAirbnbNairobiWhatWorks,
  },
  {
    meta: parkingAndArrivalAirbnbNairobiMeta,
    Component: ParkingAndArrivalAirbnbNairobi,
  },
  {
    meta: noiseAndBlackoutCurtainsAirbnbNairobiMeta,
    Component: NoiseAndBlackoutCurtainsAirbnbNairobi,
  },
  {
