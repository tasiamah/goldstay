...
import { SIGNING_CAPACITY_ATTESTATION } from "@/lib/signing-capacity";
...
export function SignAgreementForm({
  ...
  action: FormAction;
  clientName: string;
  // Drives the authority tick. The wording matches clause 2 of the
  // agreement above, so a rent-to-rent client is confirming the
  // permission-to-sublet warranty in the words it's written in.
    ...
    <section className="rounded-lg border border-stone-200 bg-white p-6">
      ...
      <form action={formAction} className="mt-5 space-y-5">
        ...
        <label className="flex items-start gap-3 text-sm text-stone-700">
          ...
          />
          <span>
            {SIGNING_CAPACITY_ATTESTATION[signingCapacity]} I have the right
            to let this property out and to sign this agreement.
          </span>
        </label>
