// /client/transactions → /client/statements
//
// The transactions ledger and the monthly statements page were
// merged into a single /client/statements surface. We keep this
...
export default function ClientTransactionsRedirect({
  searchParams,
}: {
  searchParams?: {
    period?: string;
  ...
  redirect(qs ? `/client/statements?${qs}` : "/client/statements");
}
