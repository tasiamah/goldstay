...
import { bulkArchiveClientsAction } from "./bulk-actions";

// Sticky bottom bar shown when one or more client rows are selected.
// Reads checkbox state from the surrounding <form id="clients-form">
      ...
      <button
        ...
        onClick={() => {
          ...
          startTransition(async () => {
            try {
              const res = await bulkArchiveClientsAction(fd);
