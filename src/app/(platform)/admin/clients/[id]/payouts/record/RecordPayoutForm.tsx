    ...
    <form
      action={(formData) => {
        ...
        startTransition(async () => {
          const action = recordPayoutAction.bind(null, clientId);
    ...
    >
      ...
      <label className="block text-sm">
        ...
        <textarea
          ...
          placeholder='Defaults to "Payout to <method label>". Override if you want the client to see a richer note on their statement.'
        />
      </label>
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs text-stone-500">
          The client sees this on their next statement immediately.
        </p>
      </div>
    </form>
  );
