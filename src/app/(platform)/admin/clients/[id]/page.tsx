      ...
      <div>
        ...
        <div className="mt-2 flex items-end justify-between gap-4">
          <div>
            ...
            {formatClientSecondaryName(client) ? (
              <p className="text-sm text-stone-700">
                {formatClientSecondaryName(client)}
              </p>
            ) : null}
            <p className="text-sm text-stone-500">
              {client.email} · {client.country === "KE" ? "Kenya" : "Ghana"} ·{" "}
              {client.preferredCurrency}
            </p>
            <p className="mt-2 flex flex-wrap items-center gap-2">
              <ResendWelcomeButton clientId={client.id} />
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href={`/admin/clients/${client.id}/payouts/record`}
            ...
            <Link
              href={`/admin/clients/${client.id}/properties/new`}
        ...
        <div className="rounded-lg border border-stone-200 bg-white p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs uppercase tracking-wider text-stone-500">
              ...
              {client.properties.length === 1 ? "asset" : "assets"}
            </span>
          </div>
