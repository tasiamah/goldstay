...
import { ClientDocumentRow } from "./ClientDocumentRow";
...
export async function ClientDocumentsCard({ clientId }: { clientId: string }) {
    ...
    <div className="rounded-lg border border-stone-200 bg-white p-6">
      ...
      {documents.length === 0 ? (
        <p className="mt-5 rounded-md border border-dashed border-stone-300 bg-stone-50 p-5 text-sm text-stone-600">
          No client documents on file yet. Upload at least one ID
